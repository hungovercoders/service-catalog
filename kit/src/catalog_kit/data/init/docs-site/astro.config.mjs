...
// catalog.json is generated by `catalog docs data` (task docs:generate).
const dataFile = new URL('./src/data/catalog.json', import.meta.url);
const catalog = existsSync(dataFile)
